        ...
        S: {
            V: {
                I :{
                    name : "성 김대건 안드레아",
                    summary: "조선 최초의 사제",
                    description : "성 김대건 안드레아(1821-1846)는 조선 최초의 가톨릭 사제로서 신앙을 지키고 전파하는 데 온 삶을 바친 성인입니다. 조선 시대의 박해 속에서도 교회의 전통과 가르침을 지키며 신앙 공동체를 보호하는 데 헌신했습니다. 또한, 사제가 부족했던 조선에서 적극적으로 복음을 설파하며, 신자들에게 성사를 집전하고 교리를 가르치는 일을 중요하게 여겼습니다. 그는 단순한 설교에 그치지 않고 신자들의 필요를 직접 채우며 봉사했습니다. 성사를 통해 신앙 공동체를 돌보고, 조선 교회의 기반을 마련하기 위해 노력했습니다. 교회 공동체 내에서 신앙을 지키는 것을 무엇보다 중요하게 여기며, 박해 속에서도 신자들이 흔들리지 않도록 도왔습니다. 그분의 희생과 신앙은 한국 교회의 뿌리가 되었으며, 오늘날까지 많은 이들에게 깊은 영감을 주고 있습니다.",
                    imageSrc : "/img/StKimAndr.png"
                },
                E: {
                    name : "그레고어 멘델",
                    summary: "유전학의 아버지",
                    description : "그레고어 멘델(1822-1884)은 신앙을 지키며 학문을 통해 진리를 탐구하고, 가르침과 봉사를 통해 교회와 과학 발전에 기여한 성직자이자 유전학의 선구자입니다. 그는 수도자로서 교회의 전통과 가치를 소중히 여기며, 하느님의 창조 질서를 연구하는 것이 신앙을 더욱 깊이 이해하는 길이라고 믿었습니다. 또한, 적극적으로 지식을 전파하며 과학과 신앙이 조화를 이룰 수 있음을 강조했습니다. 수도원에서 학생들을 가르치고 연구를 수행하며, 교육과 학문의 중요성을 설파했습니다. 그는 실험과 연구뿐만 아니라 공동체를 위해 봉사하는 삶을 실천하며, 수도원 내부에서 형제들과 지식을 공유하고 신앙 공동체의 발전을 위해 헌신했습니다. 그의 연구는 오늘날 유전학의 기초가 되었으며, 신앙과 학문의 조화를 이루는 모범이 되어 후대에도 큰 영향을 미치고 있습니다.",
        ...
        S: {
            V: {
                I :{
                    name : "성 요한 보스코",
                    summary: "청소년의 아버지",
                    description : "성 요한 보스코(1815-1888)는 가난한 청소년들의 교육과 신앙을 위해 헌신하신 성인입니다. 당시 사회의 변화 속에서 그는 엄격한 훈육 대신 사랑과 신뢰를 바탕으로 한 예방 교육 시스템을 도입하여 청소년들이 올바른 길을 갈 수 있도록 돕는 개혁적인 교육을 실천했습니다. 또한, 복음을 적극적으로 전파하며 신앙을 쉽게 받아들일 수 있도록 연극, 음악, 글 등을 활용했습니다. 단순한 가르침을 넘어 직접 청소년들과 함께 생활하며 봉사하며, 그들의 필요를 채워주었습니다. 이를 위해 성당과 학교, 직업 훈련소를 설립하며 교회 공동체 안에서의 활동을 중시했고, 신앙 교육과 성사를 통해 청소년들이 하느님과 깊이 연결될 수 있도록 도왔습니다. 그분의 사명은 살레시오 수도회를 통해 오늘날까지 이어지며, 신앙과 교육이 결합된 혁신적인 사목의 모범이 되고 있습니다.",
                    imageSrc : "/img/StIoBosco.png"
                },
                E: {
                    name : "성 이냐시오",
                    summary: "예수회의 창립자",
                    description : "성 이냐시오(1491-1556)는 스페인 바스크 지방에서 태어났습니다. 젊은 시절 군인으로 활동하던 중, 팜플로나 전투에서 부상을 당해 회복 기간 동안 신앙 서적을 읽으며 회심하게 되었습니다. 이후 몬세라트와 만레사에서 영적 수련을 하며 깊은 신앙 생활을 이어갔습니다. 파리에서 여섯 명의 동료와 함께 예수회를 창설하였고, 1540년 교황 바오로 3세로부터 공식 인가를 받았습니다. 그는 《영신 수련》이라는 영적 지침서를 저술하여 많은 이들에게 영적 지도를 제공하였습니다. 예수회는 교육, 선교, 자선 활동을 통해 가톨릭 교회의 쇄신에 크게 기여하였습니다.",
            ...
            D: {
                I :{
                    ...
                    description : "성 요한 크리소스토모(347-407)는 시리아 안티오키아에서 태어나, 법철학과 설교학을 공부한 후 369년에 세례를 받았습니다. 이후 은수자들과 함께 금욕생활을 하며 신앙을 깊게 다졌습니다. 386년 사제로 서품된 그는 탁월한 설교로 명성을 얻어 '황금의 입'이라는 별칭을 얻었습니다.이후 콘스탄티노플의 주교로 임명되어 가난한 이들을 위한 구호소와 병자들을 위한 호스피스를 설립하고, 이방인 지역에 선교사를 파견하는 등 활발한 사목 활동을 펼쳤습니다. 그러나 고위 성직자와 관료들의 사치와 부패를 비판하여 황후의 반감을 사게 되었고, 결국 두 차례 추방되어 두 번째 유배 중에 세상을 떠났습니다. 그의 저서와 설교, 성서 주석은 오늘날까지도 큰 영향을 미치고 있습니다. 특히 동방정교회에서 이 성인의 위상은 절대적이며, 이 성인이 다듬은 예배를 주로 행하고 있습니다.",
                    imageSrc : "/img/StIoChrysostomus.png"
                },
                E: {
                    name : "성 요한 바오로 2세",
                    summary: "현대 가톨릭의 아버지",
                    description : "성 요한 바오로 2세(1920-2005)는 현대 가톨릭 교회의 개혁을 이끈 교황으로, 신앙의 본질을 지키면서도 시대에 맞게 교회를 변화시키는 데 앞장섰습니다. 그는 세계 곳곳을 방문하며 신앙을 설파하고 대중과 소통하는 개혁적인 교황이었습니다.   또한, 강력한 지도력으로 복음을 전파하며, 대중 연설과 미디어를 적극 활용했습니다. 특히 세계 청년 대회(WYD)를 창설하여 젊은이들을 신앙으로 이끌었습니다. 그는 교회 밖에서도 인권과 자유를 위해 싸우며, 공산주의와 독재에 맞서 신앙을 실천했습니다. 그분의 업적은 오늘날까지도 신앙과 사회의 조화를 이루는 모범이 되고 있습니다.",
